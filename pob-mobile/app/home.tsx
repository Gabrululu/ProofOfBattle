    ...
    <View style={styles.myRobotSection}>
      ...
      {!publicKey ? (
        ...
        >
          ...
          <Text style={styles.myRobotCta}>Tap to manage · ENTER BATTLE below</Text>
        </TouchableOpacity>
      ) : (
        <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  cardVs:     { color: C.textDim, fontSize: 16, fontWeight: "900", letterSpacing: 4 },
  cardSerial: { fontFamily: MONO, color: C.textDim, fontSize: 8, letterSpacing: 1 },
  cardInfo: {
    flexDirection: "row", justifyContent: "space-between",
    alignItems: "center", padding: 14, paddingHorizontal: 18,
  },
  cardTitle: { color: C.textPrimary, fontSize: 14, fontWeight: "700", letterSpacing: 1 },
  cardPath:  { fontFamily: MONO, color: C.textDim, fontSize: 9, marginTop: 3 },
